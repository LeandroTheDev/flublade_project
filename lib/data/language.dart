...
class Language {
  ...
  static const en_US = {
    ...
    'response_dead': "Dead",
    'response_view': 'View',
    'response_version_mismatch': 'Your game version is different from server version please update your game',
    ...
    'authentication_invalid_login': 'Invalid Session',
    'authentication_temporary_blocked': 'You are temporary blocked',
    'authentication_lost_connection': 'You have lost connection to the servers.',
    'authentication_no_connection': 'You need to connect to a server',
    //Main Menu
    'mainmenu_play': 'Play',
    ...
    'characters_create_you': 'You',
    'characters_create_type': 'Type',
    'characters_create_hair': 'Hair',
    'characters_create_hair_color': 'Hair Color',
    'chatacters_create_eyes': 'Eyes',
    'characters_create_eyes_color': 'Eyes Color',
    'characters_create_mouth': 'Mouth',
    'characters_create_mouth_color': 'Mouth Color',
    'characters_create_skin': 'Skin',
    'characters_create_skin_color': 'Skin Color',
    'characters_create_gender': 'Gender',
    'characters_create_race': 'Race',
    ...
    'characters_race_human': 'Human',
    'characters_race_nature': 'Nature',
    'characters_race_dytol': 'Dytol',
    'characters_race_aghars': 'Aghars',
    'characters_race_dark': 'Dark',
    'characters_race_undead': 'Undead',
  ...
  static const pt_BR = {
    ...
    'response_version_mismatch': 'A versão do seu jogo está diferente da versão do servidor, por favor atualize seu jogo',
    ...
    'authentication_invalid_login': 'Sessão Inválida',
    'authentication_temporary_blocked': 'Você está temporariamente bloqueado',
    'authentication_lost_connection': 'Conexão com o servidor foi perdida.',
    'authentication_no_connection': 'Você precisa se conectar em um servidor primeiro',
    //Main Menu
    'mainmenu_play': 'Jogar',
    ...
    'characters_create_you': 'Você',
    'characters_create_type': 'Tipo',
    'characters_create_hair': 'Cabelo',
    'characters_create_hair_color': 'Cor do Cabelo',
    'chatacters_create_eyes': 'Olhos',
    'characters_create_eyes_color': 'Cor dos Olhos',
    'characters_create_mouth': 'Boca',
    'characters_create_mouth_color': 'Cor da Boca',
    'characters_create_skin': 'Tipo de Pele',
    'characters_create_skin_color': 'Cor da Pele',
    'characters_create_gender': 'Gênero',
    'characters_create_race': 'Raça',
