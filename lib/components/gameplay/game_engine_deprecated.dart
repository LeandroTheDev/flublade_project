...
class GameEngineDeprecated extends FlameGame with HasCollisionDetection, ChangeNotifier, HasGameRef {
  //Engine Declarations
  late final BuildContext context;
  late final Engine baseEngine;
  late final GameEngineDeprecated engine;
  ...
  void onMount() async {
    ...
    engine = Provider.of<GameEngineDeprecated>(context, listen: false);
