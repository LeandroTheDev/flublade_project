      ...
      body: SingleChildScrollView(
        child: Column(children: [
          SizedBox(
            ...
            child: FittedBox(
              child: Text(
                Language.Translate('response_skills', options.language) ??
                    'Skills',
                                        ...
                                        child: SingleChildScrollView(
                                          child: Column(
                                            children: [
                                              Text(
                                                Language.Translate(
                                                        'magics_${skills[index]['name']}_desc',
                                                        options.language) ??
                                                    'Language Error',
                                                style: TextStyle(
          ...
          SizedBox(
            ...
            child: FittedBox(
              child: Text(
                Language.Translate('response_passives', options.language) ??
                    'Passives',
                style: TextStyle(color: Theme.of(context).primaryColor),
              ),
            ),
